    ...
    <>      
      <div className="bonus-report-card-container" >
        ...
        <div className="bonus-report-info-container">
          ...
          <h1 className="agent-name" style={{ fontSize: info?.myan_font ? '120px' :  name_size }}>
            {info?.agent_name}
          </h1>            
          ...
          <div
            ...
            className={info?.bonus_products?.length > 8 ? 'bonus-product-list-more-eight' : 'bonus-product-list-less-eight'}
              style={{
                rowGap:
